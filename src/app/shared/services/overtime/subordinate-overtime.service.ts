...
export class SubordinateOvertimeService {
  ...
  // Create Prior Approval request
  // POST /v1​/employee​/overtime​/prior-approval
  postStaffPortalNewPriorApprovalRequestBulk(data) {
    const httpOptions = this._httpHeaderService.prepareOptions();
    const body = JSON.stringify(data);
  ...
  getOvertimePriorApprovalRequestsFilterByDate(pageNo, pageSize, employeeId, filterByDate) {
    const httpOptions = this._httpHeaderService.prepareOptions();
    // const params = `?page=${pageNo}&page_size=${pageSize}&employee_id=${employeeId}`;
    const params = `?page=${pageNo}&page_size=${pageSize}&employee_id=${employeeId}&filter_by_key_date=${filterByDate}`;
  ...
  // https://staff-app-api-dev-01.mwsc.com.mv/v1/employee/overtime/prior-approvals/by-date
  // ?overtime_prior_approval_planned_from=12%2F12%2F2020&overtime_prior_approval_planned_to=12%2F12%2F2020
  ...
  // Get All Overtime Requests (List)
  getStaffPortalOvertimeRequestsWithPaginationFilter(pageNo, pageSize, employeeId) {
    const httpOptions = this._httpHeaderService.prepareOptions();
    const params = `?page=${pageNo}&page_size=${pageSize}&employee_id=${employeeId}`;
  ...
  // /v1/employee/overtime-request/history
