...
@Component({
  selector: 'app-online-payments-actions',
  templateUrl: './online-payments-actions.component.html',
  styleUrls: ['./online-payments-actions.component.scss']
})
export class OnlinePaymentsActionsComponent implements OnInit, OnDestroy {
  ...
  manuallyUpdatedToSap(selectedleaveData) {
    // this.request_item.api_update_available = true;
