...
@Component({
  selector: 'app-online-payments-common-view',
  templateUrl: './online-payments-common-view.component.html',
  styleUrls: ['./online-payments-common-view.component.scss']
})
export class OnlinePaymentsCommonViewComponent implements OnInit {
