...
@Component({
  selector: 'app-online-payments-view',
  templateUrl: './online-payments-view.component.html',
  styleUrls: ['./online-payments-view.component.scss']
})
export class OnlinePaymentsViewComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  showViewActionModal(requestData) {
    ...
    this.request_item.history = requestData.Transaction.History;
