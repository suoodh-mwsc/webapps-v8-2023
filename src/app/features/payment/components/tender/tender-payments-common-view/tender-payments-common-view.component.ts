...
@Component({
  selector: 'app-tender-payments-common-view',
  templateUrl: './tender-payments-common-view.component.html',
  styleUrls: ['./tender-payments-common-view.component.scss']
})
export class TenderPaymentsCommonViewComponent implements OnInit {
