...
@Component({
  selector: 'app-tender-payments-view',
  templateUrl: './tender-payments-view.component.html',
  styleUrls: ['./tender-payments-view.component.scss']
})
export class TenderPaymentsViewComponent implements OnInit, OnDestroy, AfterViewInit {

  // OnDestroy 
  componentDestroyed$: Subject<boolean> = new Subject();
  // API - View Component Data
  request_item: any = {
    selected_user: [], accounts: [], notifications: [], applications: [],
  ...
  getNotifications() {
    ...
    // this._externalPayments.postePortalUserNotifications(
    //   {
  ...
  getApplications() {
    this.request_item.show_model_loader = true;
    this.request_item.notifications.items = [];
    this._externalPayments.postePortalUserSearch(
      {
        'Username': this.request_item.selected_user.UserName,
        'PageSize': this.request_item.notification_pagesize,
        'PageNumber': this.request_item.notification_number
  ...
  selectAccount(requestData) {
    ...
    this.request_item.accounts = requestData.UtilityAccounts;
    console.log('ngOnInit -> this.request_item.accounts ', this.request_item.accounts);
    console.log('ngOnInit -> this.request_item.accounts.length ', this.request_item.accounts.length);
  }
