...
@Component({
  selector: 'app-multiple-ac-payments-common-view',
  templateUrl: './multiple-ac-payments-common-view.component.html',
  styleUrls: ['./multiple-ac-payments-common-view.component.scss']
})
export class MultipleAcPaymentsCommonViewComponent implements OnInit {
