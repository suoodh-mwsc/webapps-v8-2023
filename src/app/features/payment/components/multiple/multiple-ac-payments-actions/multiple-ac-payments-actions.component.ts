...
@Component({
  selector: 'app-multiple-ac-payments-actions',
  templateUrl: './multiple-ac-payments-actions.component.html',
  styleUrls: ['./multiple-ac-payments-actions.component.scss']
})
export class MultipleAcPaymentsActionsComponent implements OnInit, OnDestroy {
