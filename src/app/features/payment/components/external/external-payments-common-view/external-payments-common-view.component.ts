...
@Component({
  selector: 'app-external-payments-common-view',
  templateUrl: './external-payments-common-view.component.html',
  styleUrls: ['./external-payments-common-view.component.scss']
})
export class ExternalPaymentsCommonViewComponent implements OnInit {
