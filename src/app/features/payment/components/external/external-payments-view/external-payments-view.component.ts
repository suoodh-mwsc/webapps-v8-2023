...
@Component({
  selector: 'app-external-payments-view',
  templateUrl: './external-payments-view.component.html',
  styleUrls: ['./external-payments-view.component.scss']
})
export class ExternalPaymentsViewComponent implements OnInit, OnDestroy, AfterViewInit {
