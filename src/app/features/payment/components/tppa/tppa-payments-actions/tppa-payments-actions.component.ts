...
@Component({
  selector: 'app-tppa-payments-actions',
  templateUrl: './tppa-payments-actions.component.html',
  styleUrls: ['./tppa-payments-actions.component.scss']
})
export class TppaPaymentsActionsComponent implements OnInit, OnDestroy {
