...
@Component({
  selector: 'app-shift-employee-view',
  templateUrl: './shift-employee-view.component.html',
  styleUrls: ['./shift-employee-view.component.scss']
})
export class ShiftEmployeeViewComponent implements OnInit, OnDestroy, AfterViewInit {
