...
@Component({
  selector: 'app-shiftgroup-view',
  templateUrl: './shiftgroup-view.component.html',
  styleUrls: ['./shiftgroup-view.component.scss']
})
export class ShiftgroupViewComponent implements OnInit, OnDestroy, AfterViewInit {
