...
@Component({
  selector: 'app-shiftgroup-manage-view',
  templateUrl: './shiftgroup-manage-view.component.html',
  styleUrls: ['./shiftgroup-manage-view.component.scss']
})
export class ShiftgroupManageViewComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  // Wizard
  tabUi: any = {
    selectedTab: 'requestWeeklyShifts', disableShiftEmployees: true, disableShiftSupervisors: false, disableWeeklyShifts: false
  };
  ...
  selectTab(step) {
    ...
    if (step === 'requestWeeklyShifts') {
      this.tabUi.selectedTab = step;
      this.tabUi.disableWeeklyShifts = true;
      this.tabUi.disableShiftEmployees = false;
      this.tabUi.disableShiftSupervisors = false;
    } else if (step === 'requestShiftEmployees') {
      this.tabUi.selectedTab = step;
      this.tabUi.disableWeeklyShifts = false;
      this.tabUi.disableShiftEmployees = true;
      this.tabUi.disableShiftSupervisors = false;
    } else if (step === 'requestShiftSupervisors') {
      this.tabUi.selectedTab = step;
      this.tabUi.disableWeeklyShifts = false;
      this.tabUi.disableShiftEmployees = false;
      this.tabUi.disableShiftSupervisors = true;
    }
  }
  ...
  goToWeeklyshift(requestData) {
    this._router.navigate(['/dutyroster/weeklyshift', this.filter.selected_shiftgroup_Id , requestData]);
  }
