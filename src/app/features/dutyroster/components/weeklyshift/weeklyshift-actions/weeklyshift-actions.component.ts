...
@Component({
  selector: 'app-weeklyshift-actions',
  templateUrl: './weeklyshift-actions.component.html',
  styleUrls: ['./weeklyshift-actions.component.scss']
})
export class WeeklyshiftActionsComponent implements OnInit, OnDestroy {
