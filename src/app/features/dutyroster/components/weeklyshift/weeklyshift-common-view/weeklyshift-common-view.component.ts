...
@Component({
  selector: 'app-weeklyshift-common-view',
  templateUrl: './weeklyshift-common-view.component.html',
  styleUrls: ['./weeklyshift-common-view.component.scss']
})
export class WeeklyshiftCommonViewComponent implements OnInit {
