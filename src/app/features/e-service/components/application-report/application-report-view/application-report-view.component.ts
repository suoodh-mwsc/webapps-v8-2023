...
@Component({
  selector: 'app-application-report-view',
  templateUrl: './application-report-view.component.html',
  styleUrls: ['./application-report-view.component.scss']
})
export class ApplicationReportViewComponent implements OnInit, OnDestroy, AfterViewInit {
