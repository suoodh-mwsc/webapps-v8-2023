...
@Component({
  selector: 'app-application-pending-view',
  templateUrl: './application-pending-view.component.html',
  styleUrls: ['./application-pending-view.component.scss']
})
export class ApplicationPendingViewComponent implements OnInit, OnDestroy, AfterViewInit {
