...
@Component({
  selector: 'app-e-service-user-view',
  templateUrl: './e-service-user-view.component.html',
  styleUrls: ['./e-service-user-view.component.scss']
})
export class EServiceUserViewComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  getNotifications() {
    ...
    this._eService.postePortalUserNotifications(
      {
